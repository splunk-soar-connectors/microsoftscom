...
This table lists the configuration variables required to operate Microsoft SCOM. These variables are specified when configuring a SCOM asset in Splunk SOAR.
